...
This repository contains all necessary files to complete BCNC's technical test. The following file explains all the steps to execute each and every one of the proposed challenges.
